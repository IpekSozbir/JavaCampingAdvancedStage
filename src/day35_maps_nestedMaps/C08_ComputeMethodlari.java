...
public class C08_ComputeMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // eger map'de X varsa degerini 40 yap
        if (harfler.containsKey("X")) {
            harfler.put("X",40);
        }
        System.out.println(harfler);

        // eger map'de Y varsa degerini 40 yap
        ...
        // eger map'de Q yoksa degerini 15 olarak ekleyin
        if (! harfler.containsKey("Q")) {
            harfler.put("Q",15);
        }
        System.out.println(harfler);

        // Java bu islemler icin hazir methodlar olusturmustur

        // eger map'de R yoksa degerini 12 olarak ekleyin

        harfler.putIfAbsent("R",12);
        System.out.println(harfler); // {F=30, M=50, Q=15, R=12, T=25, X=40, Z=10}

        harfler.putIfAbsent("M",23);
        // {F=30, M=50, Q=15, R=12, T=25, X=40, Z=10}
        // yoksa dedi ama var o yuzden degistirmedi

        // map'e M varsa degerini 2 katina cikarin
        harfler.computeIfPresent("M",(k,v) -> v*2);
        System.out.println(harfler);
        // {F=30, M=100, Q=15, R=12, T=25, X=40, Z=10}
        ...
        System.out.println(harfler);
        // {F=30, M=100, N=17, Q=15, R=12, T=25, X=40, Z=10}
