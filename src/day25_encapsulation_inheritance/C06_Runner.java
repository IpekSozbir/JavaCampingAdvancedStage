...
public class C06_Runner {
    public static void main(String[] args) {
        ...
        /*
        Bir variable'i public yapmak ile private yapip getter ve setter'i birlikte olusturmak
        arasinda islevsel olarak fark kalmaz

        yapilan isleme vurgu yapildigindan
        bazi Developer'lar public yapmak yerine bu yontemi tercih ederler
         */
