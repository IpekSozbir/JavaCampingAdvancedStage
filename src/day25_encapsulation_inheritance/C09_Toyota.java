...
public class C09_Toyota extends C08_Araba {
    ...
    // modeli olmayan bir araç yok
    // o zman bu toyota corolla class'i kendisinden obje olusturmak icin degil
    ...
    // ornegin bu class'da marka, kasa veya motor variable'lari olmasa da parent class'daki var olan variable'lari kullanabiliriz
    ...
    // 2 - toyota class'i isterse parent class'i olan araba class'indaki bazi variablelari kendine uyarlayabilir
