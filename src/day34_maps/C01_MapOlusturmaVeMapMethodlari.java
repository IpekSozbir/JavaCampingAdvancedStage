...
public class C01_MapOlusturmaVeMapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // map'de ogrencilerin numarasi, isim, soyisim, sinif, sube ve bolumleri olsun
        ...
        // Map'e eklemek icin put () kullanilir
        ...
        System.out.println(ogrenciMap);
        // ayni islem put () ile de yapilabilir
        ...
        // eger boyleyse boyle yap, yani kontrollu

        // map'deki tum keyleri ayri bir Java yapisina kaydedin
        ...
        NOT: eger bize verilen gorev sadece value'ler ile ilgili ise
             ogrenciValueCollection'ini kullanabiliriz
             ama hem key hem de value'ye ihtiyacimiz varsa
             ogrenciKeySeti'ni kaydedip
             sonra key kullanarak value'ye de ulasabiliriz
