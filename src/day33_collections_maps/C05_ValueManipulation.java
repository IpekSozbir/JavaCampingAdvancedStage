...
public class C05_ValueManipulation {
    ...
    public static void main(String[] args) {
        ...
        // isim-soyisim-simnif-sube-bolum bilgilerini value olarak tutuyoruz
        // asagida verilen value'deki isim ve soyismi yazidirin
        ...
        System.out.println(bilgiler[0] + " "+ bilgiler[1]);

        value = "Veli-Cem-11-K-TM";

        // kullanicidan gecmek istedigi bolumu secip
        ...
        // array haline gelince istedigimiz bilgiyi yazdirabilir, update edebiliriz
        ...
        System.out.println("Value'nnun son hali: " + value);
